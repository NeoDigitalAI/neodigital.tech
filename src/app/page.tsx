...
function useTranslatedData() {
  ...
  const services: CardStackItem[] = [
    ...
    { id: 3, title: "AI Avatars", description: "Hyper-realistic avatars and voice agents that look and sound completely human.", href: "/services/ai-avatars", imageSrc: "/images/ai-avatars.jpg" },
