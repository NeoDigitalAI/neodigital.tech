    ...
    <div className="bg-black text-white min-h-screen">
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-gray-300 text-lg md:text-xl mb-8 max-w-3xl">
          AI-powered strategies, content creation and automation that actually convert. Transform your marketing with AI.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-400">Create compelling content tailored to your audience instantly.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-white mb-2">SEO Optimization</h3>
            <p className="text-gray-400">Boost your visibility with AI-driven SEO strategies.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-white mb-2">Social Media Automation</h3>
            <p className="text-gray-400">Schedule and post content across platforms effortlessly.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-white mb-2">Email Campaign Optimization</h3>
            <p className="text-gray-400">Personalized email campaigns with higher open and click rates.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-white mb-2">Performance Analytics</h3>
            <p className="text-gray-400">Deep insights into what's working and what needs adjustment.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-white mb-2">Conversion Rate Optimization</h3>
            <p className="text-gray-400">Turn more visitors into customers with data-driven tweaks.</p>
          </div>
        </div>
